                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (image is XFile) Image.file(File(image!.path), height: 120),
                        if (image is String && image.isNotEmpty) Image.network("$url/storage/uploads/visitation/$image", height: 120),
                      ],
                    ),
                  ),
                ),
